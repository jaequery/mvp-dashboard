...
import { useUserResetPassword } from '../hooks/user.hooks';
...
export default function ForgotPage() {
  ...
  useEffect(() => {
    if (!resetRes.isLoading && resetRes.isSuccess) {
      setMsg(
        'Your password has been reset, please login with the new password',
      );
    }
  }, [resetRes.isLoading, resetRes.isSuccess]);
  ...
  return (
    <RegistrationLayout>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {router.query.accessToken && !resetRes.isSuccess && (
